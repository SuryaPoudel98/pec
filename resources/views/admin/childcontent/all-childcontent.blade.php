    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                ...
                <a href="{{ url('/all-childcontent') }}" style="display: none;" id="returnBack" class="btn add-btn"><i class="fa fa-arrow-left"></i>Return</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td style="width: 700px;">{!! $childcontent->text !!}</td>
                                    <td> <img src="uploads/thumbnailimg/{{ $parentcontent->Thumbnailimg }} " width="100px"> --}}
                            </td>
                            <td class="text-center">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="#deleteParentpage" data-toggle="modal" onclick="deleteItem({{ $childcontent->id }})" data-target="deleteParentpage"><i class="fa fa-trash-o m-r-5"></i>
                                            Delete</a>
                                    </div>
                                </div>
                            </td>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $("#childpage_id").append('<option value="' + value.id + '">' + value.child_title + '</option>');
                        });
                    },
                });
            } else {
