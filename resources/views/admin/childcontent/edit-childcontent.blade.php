        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <a href="{{ url('/all-childcontent') }}" style="display: true;" id="returnBack" class="btn add-btn"><i class="fa fa-arrow-left"></i>Return</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ route('childcontent.update',$childcontent->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <img id="previewImg" src="" alt="image" onerror='this.style.display = "none"'>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="text" class="form-control" placeholder="Write here Description"> {{ $childcontent->text }}</textarea>
