...
Route::get('/itemList/{id}/{title}', function () {
    return view('frontend.itemList');
});

Route::get('/notice/{title}', function () {
    return view('frontend.noticeList');
});

//
Route::get('/download/{title}', function () {
    return view('frontend.download');
});
Route::get('/publication/{title}', function () {
    return view('frontend.publication');
});
//
Route::get('/Achievement/{title}', function () {
    return view('frontend.achievements');
});

Route::get('/gallery/{title}', function () {
    return view('frontend.gallery');
});

Route::get('/noticeDetails/{id}', function () {
    return view('frontend.noticeDetails');
});
...
Route::get('/parentpagedetails/{id}', [IndexController::class, 'parentpagedetails']);
...
// parent content page controller
...
//Route For slide image
Route::get('/add-slideimage', [SliderImageController::class, 'Addslider'])->name('slider');
Route::Post('/add-slideimage-store', [SliderImageController::class, 'slideimageStore'])->name('sliderimage.store');
Route::get('/all-sideimage', [SliderImageController::class, 'sliderImage'])->name('all.sliderimage');
...
//Achievements
Route::get('/add-achievement', [AchievementController::class, 'AddAchievement'])->name('achievement');
Route::post('/add-achievement', [AchievementController::class, 'AchievementStore'])->name('store.achievement');
Route::get('/all-achievement', [AchievementController::class, 'Achievement'])->name('all.achievement');
Route::get('/edit-achievement/{id}', [AchievementController::class, 'EditAchievement']);
Route::post('/update-achievement/{id}', [AchievementController::class, 'UpdateAchievement'])->name('achievement.update');
Route::get('/delete-achievement/{id}', [AchievementController::class, 'DeleteAchivement']);

//download 
Route::get('/add-download', [DownloadController::class, 'AddDownload'])->name('download');
Route::post('/add-download', [DownloadController::class, 'DownloadStore'])->name('store.download');
Route::get('/all-download', [DownloadController::class, 'Download'])->name('all.download');
Route::get('/edit-download/{id}', [DownloadController::class, 'EditDownload']);
Route::post('/update-download/{id}', [DownloadController::class, 'UpdateDownload'])->name('download.update');
Route::get('/delete-download/{id}', [DownloadController::class, 'DeleteDownload']);

Route::Post('/add-PopUpImage-store',[PopupImageController::class,'PopUpImageStore'])->name('sliderimage.store');
Route::get('/all-PopUpImage',[PopupImageController::class,'PopUpImage'])->name('PopUpImage');
Route::get('/edit-PopUpImage/{id}',[PopupImageController::class,'PopUpImageEdit']);
Route::post('/update-PopUpImage/{id}',[PopupImageController::class,'UpdatePopUpImage'])->name('PopUpImage.update');
Route::get('/delete-PopUpImage/{id}',[PopupImageController::class,'DelelePopUpImage']);